...
public class ChatsFragment extends Fragment {
    ...
    CircleImageView chatContactsImageView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       chatContactsImageView=(CircleImageView) view.findViewById(R.id.chat_contact);

        chatContactsImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), ChatsContacts.class));
